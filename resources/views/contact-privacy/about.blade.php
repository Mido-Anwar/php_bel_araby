    ...
    <div dir="rtl"
        ...
        <div class="relative max-w-4xl mx-auto z-10">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-base sm:text-lg lg:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
                    منصة عربية لتوثيق لغات البرمجة — بدأت كمشروع شخصي، وبقت مرجع لكل مبرمج عربي.
                </p>
            </div>

            {{-- القصة --}}
            <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 sm:p-8 mb-10">
                <h2 class="text-2xl font-bold text-white mb-4 text-yellow-400">القصة</h2>

                <div class="text-slate-300 space-y-4 leading-relaxed">
                    <p>
                        بدأت رحلتي مع البرمجة من الصفر — من غير شهادة، ومن غير وسيط،
                        ومن غير أي ضمان. كانت الرحلة صعبة، خصوصًا إني بدوّر على
                        مصادر عربية ومالقيتش.
                    </p>
                    <p>
                        كنت بلاقي محتوى إنجليزي كتير، بس عربي — نادر. واللي موجود
                        بيكون سطحي أو مترجم بشكل ركيك.
                    </p>
                    <p>
                        فقررت أعمل المكان اللي كنت نفسي ألاقيه. منصة توثيق عربية
                        شاملة، بمحتوى أصلي وعميق، لكل مبرمج عربي عايز يفهم — مش بس يحفظ.
                    </p>
                    <p class="text-yellow-400 font-semibold">
                        وده كان مشروعي الشخصي الأكبر: PHP بالعربي.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 sm:p-8 mb-10">
                ...
                <p class="text-slate-300 leading-relaxed">
                    أؤمن إن المحتوى العربي في البرمجة لازم يكون بعمق وجودة تنافس المحتوى
                    الإنجليزي. مش كفاية إننا نترجم — لازم نأصّل. وعشان كده، كل مقال
                    على الموقع ده مكتوب بحب، وبمعلومات من واقع التجربة.
                </p>
            </div>

            {{-- التواصل --}}
            <div class="text-center">
                <p class="text-slate-400 text-sm mb-4">عندك سؤال؟ اقتراح؟ عايز تتعاون؟</p>
            ...
            {{-- Footer --}}
            <div class="mt-16 pt-8 border-t border-slate-800/60 text-xs sm:text-sm text-slate-400 text-center">
                <span>منصة PHP بالعربي • تم الصنع بإتقان بواسطة </span>
