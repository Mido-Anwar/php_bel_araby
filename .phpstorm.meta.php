...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ahmed-nour/dev/php_bel_araby/public/storage' => 'string',
...
'auth.guards.web.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers','auth.passwords.users.provider',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/ahmed-nour/dev/php_bel_araby/public/storage','logging.default',
...
'default.livewire.update','livewire.upload-file','livewire.preview-file','home','about','blog.main','blog.show',
'docs.show','dashboard','posts.index','post.create','post.store',
'post.show','post.edit','post.update','post.publish','post.unpublish',
'post.destroy','technology.index','technology.create','technology.store','technology.show',
'technology.edit','technology.update','technology.destroy','section.create','section.store',
'section.show','section.edit','section.update','section.destroy','concept.index',
'concept.create','concept.store','concept.show','concept.edit','concept.update',
'concept.destroy','users.index','user.create','user.store','user.edit',
'user.update','user.destroy','role.create','role.store','role.show',
'role.edit','role.update','role.destroy','permission.create','permission.store',
'permission.show','permission.edit','permission.update','permission.destroy','login','password.request','password.email','password.reset','password.store',
'register','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','logout','profile.edit',
'profile.update','profile.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'about','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','blog.main','blog.post.index','blog.post.post-create',
'blog.post.post-edit','blog.post.post-show','blog.show-post','components.application-logo','components.auth-session-status',
'components.danger-button','components.delete-form','components.dropdown','components.dropdown-link','components.input-error',
'components.input-label','components.master.doc-view','components.master.footer','components.master.header','components.message',
...
'components.text-input','dashboard','docs.main','docs.technology.section.concept.concept-create','docs.technology.section.concept.concept-edit',
'docs.technology.section.concept.concept-show','docs.technology.section.section-create','docs.technology.section.section-edit','docs.technology.section.section-show','docs.technology.technology-create',
'docs.technology.technology-edit','docs.technology.technology-index','docs.technology.technology-show','layouts.app','layouts.guest',
'layouts.master-layout','layouts.navigation','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','user.index','user.roleAndPermissionCreate','user.roleAndPermissionEdit','user.user-create',
'user.userEdit','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
